...
<html lang="en">
  <head>
    ...
    <title>Housing Meet | Contact Us</title>  
    ...
    <nav class="navbar navbar-default main-navbar" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->                                               
          <!-- Text based logo -->
                        <a class="navbar-brand aa-logo" href="Home_Page.jsp">Housing-Meet</a>
          <!-- Image based logo -->
...
<div class="calendly-inline-widget" data-url="https://calendly.com/achintrawalcs18/30min" style="min-width:320px;height:630px;"></div>
